...
const FeaturedWorks = () => {
    return (
        <div className=" md: grid grid-cols-2 justify-items-center mt-5">
  ...
  <div className="p-6">
    <div className="mb-2 flex items-center justify-between">
      ...
      TechScape Electronics
      </p>
      
    </div>
    <p className="block font-sans text-sm font-normal leading-normal text-gray-700 antialiased opacity-75">
    TechScape Electronics | Tech expo we arranged in 2002 on the office premises of techScape electronics
    </p>
  </div>
  ...
  <div className="p-6">
    ...
    <p className="block font-sans text-sm font-normal leading-normal text-gray-700 antialiased opacity-75">
    GlobeTech Manufacturing Sustainability Showcase | voice-activated Siri access, and an
  ...
  <div className="p-6">
    ...
    <p className="block font-sans text-sm font-normal leading-normal text-gray-700 antialiased opacity-75">
    StarVista Solutions Career Discovery Day | voice-activated Siri access, and an
      available wireless charging case.
    </p>
  </div>
  <div className="p-6 pt-0">
  ...
  <div className="p-6">
    ...
    <p className="block font-sans text-sm font-normal leading-normal text-gray-700 antialiased opacity-75">
    NovaLink Industries Supplier Appreciation Festival | voice-activated Siri access, and an
      available wireless charging case.
    </p>
  </div>
  <div className="p-6 pt-0">
